...
<body>
				...
				<nav class="limiter-menu-desktop p-l-45">
					...
					<div class="wrap-icon-header flex-w flex-r-m h-full">
						...
						<div class="flex-c-m h-full p-l-18 p-r-25 bor5">
							...
							<div class="icon-header-item cl2 hov-cl1 trans-04 p-lr-11 icon-header-noti js-show-cart" id="showqtycart" data-notify="{{Session::get('cart')->totalQty}}">
									<i class="zmdi zmdi-shopping-cart"></i>		
							</div>
							@else
							<div class="icon-header-item cl2 hov-cl1 trans-04 p-lr-11 icon-header-noti js-show-cart" id="showqtycart" data-notify="0">
									<i class="zmdi zmdi-shopping-cart"></i>		
							</div>
							@endif
						</div>
	...
	<script>
		...
		function deleteCart(id) {
			...
			document.getElementById("showqtycart").setAttribute('data-notify',qtyshow);
		}
	</script>
</body>
