...
@section('content')
                ...
                <div class="title">
                    <h4>Quản lý sản phẩm
                        <a href="/add-new-product">
                            <button type="button" class="btn btn-xl btn-outline-primary"><i
                                    class="icon-copy fi-plus"></i>Thêm</button>
                ...
                <tbody>
                    ...
                    @foreach ($product as $item)
                        <tr>
                            <td></td>
                            <td class="table-plus">
                                <img src="/upload/product/{{ $item->product_image }}" width="45px" height="45px"
                                    alt="">
                            </td>
                            <td>
                            ...
                            @if ($item->product_status == 1)
                                <td><span class="badge badge-pill"
                                        style="color: rgb(38, 94, 215); background-color: rgb(231, 235, 245);">Hiện</span>
                                </td>
                            @else
                                <td><span class="badge badge-pill"
                            ...
                            <td class=" text-right">
                                <div class="dropdown">
                                    ...
                                    <a class="droupdow-item product-item btn btn-dark " data-toggle="modal"
                                        data-target="#exampleModalCenter{{ $item->id }}" href="#"><i
                                            class="dw dw-eye"></i>
                                        Xem chi
                                        tiết 1</a>
                                    ...
                                    <a class="item product-item btn btn-dark"
                                        href="/view-inventory/{{ $item->id }}-<?php echo str_replace(' ', '-', $item->product_name); ?>"><i
                                    ...
                                    <a class="item product-item btn btn-dark" href="#" data-toggle="modal"
                                        data-target="#confirmation-modal{{ $item->id }}"><i class="dw dw-delete-3"
                                            data-toggle="modal" data-target="#confirmation-modal{{ $item->id }}"></i>
                                        Xóa</a>
                                    <a class="item product-item btn btn-dark"
    ...
    @foreach ($product as $item)
        <div class="modal fade" id="confirmation-modal{{ $item->id }}" tabindex="-1" role="dialog"
            aria-hidden="true">
            <form action="">
                                    ...
                                    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                                        ...
                                        <div class="carousel-inner">
                                            <div class="carousel-item active">
                                                <img src="/upload/product/{{ $item->product_image }}"
                                                    class="d-block w-100" alt="...">
                                            </div>
                                            @foreach ($image as $item2)
                                                @if ($item2->product_id == $item->id)
                                                    <div class="carousel-item">
                                                        <img src="/upload/product/{{ $item2->image }}"
                                                            class="d-block w-100" alt="...">
                                                    </div>
                                                @endif
                                            @endforeach
