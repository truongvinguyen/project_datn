      ...
      <div class="offer-add">
        ...
        <div class="col-md-4 col-sm-4 col-xs-12">
          <div class="jtv-banner-box banner-inner" style="box-shadow: rgba(0, 0, 0, 0.15) 0px 5px 15px 0px;">
            <div class="image"> <a class="jtv-banner-opacity" href="#"><img src="client/images/slider/271219003_4989708867717426_5471988687366907212_n.jpg" alt="" height="432px"></a> </div>
