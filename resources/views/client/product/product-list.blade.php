                        ...
                        <div class="layered-Category">
                            ...
                            <div class="layered-content">
                                <ul class="check-box-list">
                                    <li id="bestsell">
                                        <p><label for="jtv1"> <span class="button"></span>Bán chạy nhất</label></p>
                                    </li>
                                    <li>
                                        <p><label for="jtv2"> <span class="button"></span>Hàng mới về</label></p>
                                    </li>
                                    <li>
                                        <p><label for="jtv3"> <span class="button"></span>Nhiều bình luận nhất</label></p>
                                    </li>
                                    <li>
                                        <p><label for="jtv4"> <span class="button"></span>Giá từ thấp đến cao</label></p>
                                    </li>
                                    <li>
                                        <p><label for="jtv5"> <span class="button"></span>Giá từ cao xuống thấp</label></p>
                                    </li>
                                </ul>
                            </div>
                        </div>
